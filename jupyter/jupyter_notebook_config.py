...
#  Default: []
c.NotebookApp.extra_template_paths = [os.environ['OAUTHENTICATOR_DIR'] + '/notebook_templates']
...
#  Choices: any of ['sha3_384', 'blake2s', 'sha384', 'sha224', 'sha3_256', 'sha512', 'sha3_224', 'sha256', 'sha1', 'blake2b', 'sha3_512', 'md5']
#  Default: 'sha256'
