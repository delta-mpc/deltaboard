<template>
   <div class="task-drawer">
      <el-page-header @back="$router.go(-1)" :content="this.$t('dashboard.taskdetail.task {id}',{id:currentTaskId})"></el-page-header>
      <div class="drawer-wrapper">
         <el-descriptions title="Metadata">
            <el-descriptions-item :label="$t('common.created_at')" :labelStyle="labelStyle">{{taskLogMetaData.created_at || 0 | second2Date }}
            </el-descriptions-item>
            <el-descriptions-item :label="$t('dashboard.taskdetail.creator')" :labelStyle="labelStyle">{{taskLogMetaData.creator}}</el-descriptions-item>
            <el-descriptions-item label="ID" :labelStyle="labelStyle">{{taskLogMetaData.id}}</el-descriptions-item>
            <el-descriptions-item :label="$t('dashboard.taskdetail.task_name')" :labelStyle="labelStyle">
               {{taskLogMetaData.name}}
            </el-descriptions-item>
            <el-descriptions-item :label="$t('dashboard.taskdetail.status')" :labelStyle="labelStyle">
            ...
            <el-descriptions-item :label="$t('dashboard.tasklist.task_type')" :labelStyle="labelStyle">{{taskLogMetaData.type}}</el-descriptions-item>
         </el-descriptions>
