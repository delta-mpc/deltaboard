      ...
      <transition appear name="slide-fade">
        <div class="table-ctn">
            <el-table :data="tableData">
               <el-table-column label="节点名称" prop="name" width="200px"></el-table-column>
               <el-table-column label="节点ID" prop="id"></el-table-column>
               <el-table-column prop="url" label="节点地址"></el-table-column>
            </el-table>
         </div>
...
export default {
   ...
   beforeRouteEnter(to, from, next) {
      store.commit("sidebar/SET_NODES_PAGE");
      next();
   },
};
</script>
